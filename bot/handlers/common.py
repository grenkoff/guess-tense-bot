...
async def cmd_start_no_state(message: Message, state: FSMContext):
...
async def cmd_help(message: Message, state: FSMContext):
    await message.delete()
    await message.answer(
        text=f"This bot was created by me.\n\nHere are my 🔗 links:",
...
async def cmd_guess_no_state(message: Message, state: FSMContext):
    await message.delete()
...
async def cmd_finish_finish_or_next_state(message: Message, state: FSMContext):
    await message.delete()
    await state.clear()
    await message.answer(
...
async def tense_chosen(message: Message, state: FSMContext):
    await message.delete()
